...
async def handle_request(url: str, api_key: str, session: aiohttp.ClientSession, request, rate_limiter: RateLimiter, logger: logging.Logger): 
...
async def exchange_facing_worker(url: str, api_key: str, queue: Queue, logger: logging.Logger):
    ...
    async with aiohttp.ClientSession() as session:
        while True:
            ...
            await handle_request(url, api_key, session, request, rate_limiter, logger)
